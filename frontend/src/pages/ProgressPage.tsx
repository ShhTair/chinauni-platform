...
const FEATURES = [
  ...
  { group: 'Catalog', name: 'University Map View', status: 'in_progress', note: 'Mapbox/Leaflet cluster integration pending' },
  { group: 'Catalog', name: 'Timeline View (Deadlines)', status: 'todo', note: 'Horizontal month-based timeline needed' },
  { group: 'Universities', name: 'Detail Page', status: 'in_progress', note: 'Hero section and tabs ready, content fetching needed' },
